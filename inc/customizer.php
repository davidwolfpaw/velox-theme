...
function velox_customize_preview_js() {
	wp_enqueue_script( 'velox-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'jquery', 'customize-preview' ), '20210329', true );
}
...
function velox_customizer_css() {
	...
	<style type="text/css">
		...
		.wp-block-button__link:hover, .wp-block-button__link:active, .wp-block-button__link:focus, .hentry .entry-content a.wp-block-button__link:hover, .hentry .entry-content a.wp-block-button__link:active, .hentry .entry-content a.wp-block-button__link:focus {	background-color: <?php echo esc_html( get_theme_mod( 'link_active_color', '#0a4b78' ) ); ?>; }
		.hentry .entry-content a:not(.wp-block-button__link) { border-bottom-color: <?php echo esc_html( get_theme_mod( 'link_color', '#0a4b78' ) ); ?>; box-shadow: inset 0 -2px 0 <?php echo esc_html( get_theme_mod( 'link_color', '#0a4b78' ) ); ?>; }
		...
		#main-navigation a:hover, #main-navigation a:focus { background-color: <?php echo esc_html( get_theme_mod( 'link_color', '#0a4b78' ) ); ?>; }
		.has-text-color { color: <?php echo esc_html( get_theme_mod( 'text_color', '#1d2327' ) ); ?>; }
		.has-text-background-color { background-color: <?php echo esc_html( get_theme_mod( 'text_color', '#1d2327' ) ); ?>; }
		...
		.has-accent-color, .is-style-outline > .wp-block-button__link:not(.has-background), .wp-block-button__link.is-style-outline:not(.has-background) { color: <?php echo esc_html( get_theme_mod( 'accent_color', '#d63638' ) ); ?>; }
		.has-accent-background-color { background-color: <?php echo esc_html( get_theme_mod( 'accent_color', '#d63638' ) ); ?>; }
	</style>
	<?php
}
...
function velox_customizer_admin_css() {
	...
	<style type="text/css">
		...
		.wp-admin .editor-styles-wrapper, .wp-admin .editor-post-title__block .editor-post-title__input, .wp-admin .editor-styles-wrapper h1, .wp-admin .editor-styles-wrapper h2, .wp-admin .editor-styles-wrapper h3, .wp-admin .editor-styles-wrapper h4, .wp-admin .editor-styles-wrapper h5, .wp-admin .editor-styles-wrapper h6, .wp-admin .editor-styles-wrapper textarea, .wp-admin .editor-styles-wrapper .wp-block-quote__citation, .wp-admin .editor-styles-wrapper .wp-block-quote cite, .wp-admin .editor-styles-wrapper .wp-block-quote footer { color: <?php echo esc_html( get_theme_mod( 'text_color', '#1d2327' ) ); ?>; }
		.wp-admin .editor-styles-wrapper .wp-block-image figcaption, .wp-admin .editor-styles-wrapper .wp-block-pullquote cite, .wp-admin .editor-styles-wrapper .wp-block-pullquote .wp-block-pullquote__citation, .wp-admin .editor-styles-wrapper .wp-block-latest-posts__post-date, .wp-admin .editor-styles-wrapper .wp-caption-text, .wp-admin .editor-styles-wrapper .wp-caption-dd { color: <?php echo esc_html( get_theme_mod( 'accent_text_color', '#515962' ) ); ?>; }
		.wp-admin .editor-styles-wrapper .wp-block-button__link { background-color: <?php echo esc_html( get_theme_mod( 'link_color', '#0a4b78' ) ); ?>; }
		...
		.wp-admin .editor-styles-wrapper a { border-bottom-color: <?php echo esc_html( get_theme_mod( 'link_color', '#0a4b78' ) ); ?>; box-shadow: inset 0 -2px 0 <?php echo esc_html( get_theme_mod( 'link_color', '#0a4b78' ) ); ?>; }
		.wp-admin .editor-styles-wrapper a:hover, .wp-admin .editor-styles-wrapper a:focus, .wp-admin .editor-styles-wrapper a:active, .wp-admin .editor-styles-wrapper .wp-block-image a:active, .wp-admin .editor-styles-wrapper .wp-block-image a:focus, .wp-admin .editor-styles-wrapper .wp-block-image a:hover, .wp-admin .editor-styles-wrapper .wp-block-gallery a:active, .wp-admin .editor-styles-wrapper .wp-block-gallery a:focus, .wp-admin .editor-styles-wrapper .wp-block-gallery a:hover {	background-color: <?php echo esc_html( get_theme_mod( 'link_active_color', '#0a4b78' ) ); ?>; border-bottom: 1px solid <?php echo esc_html( get_theme_mod( 'link_active_color', '#0a4b78' ) ); ?>; box-shadow: inset 0 -2px 0 <?php echo esc_html( get_theme_mod( 'link_active_color', '#0a4b78' ) ); ?>; }
		.wp-admin .editor-styles-wrapper hr, .wp-admin .editor-styles-wrapper hr.wp-block-separator, .wp-admin .editor-styles-wrapper button:not(.components-button):not(.mce-btn button), .wp-admin .editor-styles-wrapper input[type="button"], .wp-admin .editor-styles-wrapper input[type="reset"], .wp-admin .editor-styles-wrapper input[type="submit"], .wp-admin .editor-styles-wrapper .wp-block-button .wp-block-button__link { background-color: <?php echo esc_html( get_theme_mod( 'accent_color', '#d63638' ) ); ?>; }
		.wp-admin .editor-styles-wrapper .wp-block-separator.is-style-dots:before { color: <?php echo esc_html( get_theme_mod( 'accent_color', '#d63638' ) ); ?>; }
		.wp-admin .editor-styles-wrapper hr, .wp-admin .editor-styles-wrapper .wp-block-separator { border-bottom-color: <?php echo esc_html( get_theme_mod( 'accent_color', '#d63638' ) ); ?>; }
		.wp-admin .editor-styles-wrapper .wp-block-pullquote { border-top-color: <?php echo esc_html( get_theme_mod( 'accent_color', '#d63638' ) ); ?>; border-bottom-color: <?php echo esc_html( get_theme_mod( 'accent_color', '#d63638' ) ); ?>; }
		.wp-admin .editor-styles-wrapper .wp-block-quote:not(.is-large) { border-left-color: <?php echo esc_html( get_theme_mod( 'accent_color', '#d63638' ) ); ?>; }
		.wp-admin .editor-styles-wrapper a, .wp-admin .editor-styles-wrapper a:visited { color: <?php echo esc_html( get_theme_mod( 'link_color', '#0a4b78' ) ); ?>; }
	</style>
	<?php
}
