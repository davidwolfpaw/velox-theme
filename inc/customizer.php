...
function velox_customizer_css() {
	...
	<style type="text/css">
		...
		.hentry .entry-content a:not(.wp-block-button__link) { border-bottom-color: <?php echo esc_html( get_theme_mod( 'link_color', '#065e88' ) ); ?>; box-shadow: inset 0 -2px 0 <?php echo esc_html( get_theme_mod( 'link_color', '#065e88' ) ); ?>; }
		...
		.has-accent-color, .is-style-outline > .wp-block-button__link:not(.has-background), .wp-block-button__link.is-style-outline:not(.has-background) { color: <?php echo esc_html( get_theme_mod( 'accent_color', '#c31c31' ) ); ?>; }
...
function velox_customizer_admin_css() {
	...
	<style type="text/css">
		...
		.wp-admin .editor-styles-wrapper hr, .wp-admin .editor-styles-wrapper hr.wp-block-separator, .wp-admin .editor-styles-wrapper button:not(.components-button):not(.mce-btn button), .wp-admin .editor-styles-wrapper input[type="button"], .wp-admin .editor-styles-wrapper input[type="reset"], .wp-admin .editor-styles-wrapper input[type="submit"], .wp-admin .editor-styles-wrapper .wp-block-button .wp-block-button__link { background-color: <?php echo esc_html( get_theme_mod( 'accent_color', '#c31c31' ) ); ?>; }
