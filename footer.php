...
<style type="text/css">
	body, button, input, select, optgroup, textarea {
		font-family: '<?php echo esc_attr( $body_font ); ?>', Arial, Verdana, sans-serif;
	}
	h1, h2, h3, h4, h5, h6 {
		font-family: '<?php echo esc_attr( $heading_font ); ?>', Cambria, 'Hoefler Text', Utopia, 'Liberation Serif', 'Nimbus Roman No9 L Regular', Times, 'Times New Roman', serif;
	}
</style>
