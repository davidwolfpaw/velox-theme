...
Hello there! I'm a WordPress theme based for bloggers. I'm responsive and mobile first, and I'm friendly to the WordPress Block/Gutenberg Editor!
...
* __Night Mode__ - Let visitors toggle dark mode to make the page darken for low-light reading. You can default to light mode, dark mode, or remove the toggle altogehter.
...
All of the theme settings are managed via the WordPress Customizer in the Velox Theme Settings.
