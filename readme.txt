...
* Changes default color palette to WP v5.7 defaults
* Adjusts dark mode to respond to user preferences
* Adds Work Sans font option
* Adds system font stack option
* Adds print styles
